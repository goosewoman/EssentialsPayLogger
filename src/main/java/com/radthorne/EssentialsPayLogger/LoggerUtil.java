...
class LoggerUtil
{
    ...
    public
    LoggerUtil( EssentialsPayLogger lEss )
    {
        this.ess = lEss.getEss();
    }

    public
    List<String[]> csvListToArray( List<String> csvList )
    {
        if ( csvList == null )
        {
    ...
    public
    List<String> listArrayToCsvList( List<String[]> listArray )
    {
        if ( listArray == null )
        {
            return new ArrayList<String>();
    ...
    public
    int diffTime( String oldTime, String newTime )
    {
    ...
    public
    int milliToSec( Long milli )
    {
        return ( int ) ( milli / 1000 );
    }

    public
    List<String> listArrayToStringList( List<String[]> listArray, boolean timestamp )
    {
